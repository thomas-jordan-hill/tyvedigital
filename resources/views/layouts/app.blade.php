...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="https://www.google.com/recaptcha/enterprise.js?render=6LcC7VUkAAAAAH9CweiJnoYhpdOH0HdjHwP2iFhe"></script>
        <script>
        grecaptcha.enterprise.ready(function() {
            grecaptcha.enterprise.execute('6LcC7VUkAAAAAH9CweiJnoYhpdOH0HdjHwP2iFhe', {action: 'login'}).then(function(token) {
            ...
            });
        });
        </script>
