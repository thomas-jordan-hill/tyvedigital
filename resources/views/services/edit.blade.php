...
<div class="container container-global edit-blog" id="edit-{{$blog->slug}}">
    <div class="row">
        <div class="col-12">
            <div class="row">
                <form method="POST" action="/blog/{{$blog->slug}}" class="col-12" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="form-control px-0 @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ $blog->title }}">
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="form-control px-0 @error('excerpt') is-invalid @enderror" name="excerpt" id="excerpt" value="{{ $blog->excerpt }}">
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="form-control px-0 @error('body') is-invalid @enderror" name="body" id="body" value="{{ $blog->body }}">
                        </div>
                    </div>
