...
@section('content')
                ...
                <div class="row">
                    <div class="col-12 mb-2 mb-sm-0 mt-3 mt-sm-4">
                        <div class="d-flex my-auto">
                            <p class="mb-0 mr-4 my-auto" style="white-space: nowrap;">Services</p>
                            <h2 class="mb-0 mr-4 my-auto font-weight-bold" style="white-space: nowrap;">Websites</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-0">
        <div class="row">
            <div class="col-12 mb-4">
                <h4 class="h4 mb-3">I want to...</h4>
                <nav class="nav nav-pills nav-fill">
                    <li class="nav-item pr-2">
                        <a class="nav-link active p smaller" href="#newwebsite">Get a new website</a>
                    </li>
                    <li class="nav-item px-2">
                        <a class="nav-link active p smaller" href="#updatewebsite">Update the look of my website</a>
                    </li>
                    <li class="nav-item px-2">
                        <a class="nav-link active p smaller" href="#improveseo">Improve my SEO</a>
                    </li>
                    <li class="nav-item pl-2">
                        <a class="nav-link active p smaller" href="#gainleads">Gain leads from my website</a>
                    </li>
                </nav>
            </div>
        </div>
    ...
    <!-- End -->
    <div class="container py-3" id="promo-websitepackage">
        <div class="row">
            <div class="col-12">
    ...
    <!-- New Website -->
    <div class="container container-global" id="newwebsite">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-sm-9 mb-2 mb-sm-4 mt-2 mt-sm-3">
                        <div class="mb-0">
                            <h3 class="font-weight-bold h3 mb-2">New website</h3>
                    ...
                    <div class="col-12 mb-4">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2 mt-sm-0 mt-lg-0 text-left">
                                <div class="card card-shadow radius-15 not-recommended p-2">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2 mt-sm-0 mt-lg-0 text-left">
                                <div class="card card-shadow radius-15 p-2 recommended position-relative">
                                    <div class="card-body p-4">
                                        <h3 class="m-0 p-0">Simple +</h3>
                                        <img class="card-img-top p-4" src="/storage/jan2021/test-homepage-jan2021-section2-1.png" alt="Card image cap">
                                        <h5 class="card-title">What's included</h5>
                                        ...
                                        <p class="mt-2 mb-0 text-right p smaller"><small><sup>*</sup>for a minimum of 12 months</small></p>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2 mt-sm-3 mt-lg-0 text-left">
                                <div class="card card-shadow radius-15 not-recommended p-2">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="mt-2 mb-0 text-right p smaller"><small><sup>*</sup>for a minimum of 24 months</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- End -->
    <!-- New Website -->
    <div class="container container-global" id="updatewebsite">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-sm-9 mb-2 mb-sm-4 mt-2 mt-sm-3">
                        <div class="mb-0">
                            <h3 class="font-weight-bold h3 mb-2">Update website's design</h3>
                            <p class="alt-h3 mb-0" style="font-weight: normal;">We offer three packages to make it easy for you to carry on running your business, while ensuring we build the right website for you and your brand.</p>
                        </div>
                    </div>
                    <div class="col-12 mb-4">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6 mt-2 mt-sm-0 mt-lg-0 text-left">
                                <div class="card card-shadow radius-15 p-2 not-recommended position-relative">
                                    <div class="card-body p-4">
                                        <h3 class="m-0 p-0">Build a new codebase</h3>
                                        <img class="card-img-top p-4" src="/storage/jan2021/test-homepage-jan2021-section2-1.png" alt="Card image cap">
                                        <h5 class="card-title">What's included</h5>
                                        <ul class="list-unstyled">
                                            <li class="px-0">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 mt-2 mt-sm-3 mt-lg-0 text-left">
                                <div class="card card-shadow radius-15 not-recommended p-2">
                                    <div class="card-body p-4">
                                        <h3 class="m-0 p-0">Re-design on old code</h3>
                                        <img class="card-img-top p-4" src="/storage/jan2021/test-homepage-jan2021-section2-1.png" alt="Card image cap">
                                        <h5 class="card-title">What's included</h5>
                                        <ul class="list-unstyled">
                                            <li class="px-0">
